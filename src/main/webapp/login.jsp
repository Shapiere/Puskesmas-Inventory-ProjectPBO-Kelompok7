...
<head>
    ...
    <link rel="stylesheet" href="<%=cp(request)%>/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<%=cp(request)%>/assets/css/all.min.css">
    <link rel="stylesheet" href="<%=cp(request)%>/assets/css/aos.css">
    <link rel="stylesheet" href="<%=cp(request)%>/assets/css/styles.css">
</head>
