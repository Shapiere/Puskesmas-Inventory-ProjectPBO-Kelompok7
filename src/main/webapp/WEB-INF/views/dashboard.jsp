        ...
        <body class="gradient-bg">
            <div class="d-flex min-vh-100">
                <div class="sidebar shadow-lg" data-aos="fade-right">
                    ...
                    <a href="${pageContext.request.contextPath}/dashboard" class="nav-link active"><i
                                    ...
                                    <tbody>
                                        <c:forEach items="${lowStock}" var="o">
                                            <tr>
                                                <td>${o.kodeObat}</td>
                                                <td>${o.namaObat}</td>
                                                <td><span class="badge bg-warning text-dark">${o.stokSaatIni}</span>
                                                </td>
                                                <td>${o.stokMinimum}</td>
                                                <td>${o.kategori}</td>
                                            </tr>
                                        ...
                                        <c:if test="${empty lowStock}">
                                            <tr>
                                                <td colspan="5" class="text-center text-white-50 py-3">Tidak ada stok
                                                    menipis.</td>
                                            </tr>
                                        </c:if>
                                    </tbody>
                    ...
                    <div class="card glass-card mt-4" data-aos="fade-up">
                        <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-white-50">Memantau selisih stok yang masuk dan keluar setiap
                                    bulan</small>
                            </div>
                        </div>
                        <div class="card-body">
