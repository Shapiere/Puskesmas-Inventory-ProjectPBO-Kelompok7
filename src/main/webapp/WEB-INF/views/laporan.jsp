        ...
        <body class="gradient-bg">
            <div class="d-flex min-vh-100">
                <div class="sidebar shadow-lg" data-aos="fade-right">
                    ...
                    <a href="${pageContext.request.contextPath}/laporan" class="nav-link active"><i
                                            ...
                                            <tbody>
                                                <c:forEach items="${lowStock}" var="o">
                                                    <tr>
                                                        ...
                                                        <td>${o.namaObat}</td>
                                                        <td><span
                                                                class="badge bg-warning text-dark">${o.stokSaatIni}</span>
                                                        </td>
                                                        <td>${o.stokMinimum}</td>
                                                    </tr>
                                                </c:forEach>
                                                <c:if test="${empty lowStock}">
                                                    <tr>
                                                        <td colspan="4" class="text-center text-white-50 py-3">Tidak ada
                                                            stok menipis</td>
                                                    </tr>
                                                </c:if>
                                            </tbody>
                                        ...
                                        <table class="table table-dark table-hover mb-0 align-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <c:if test="${empty monthly}">
                                                    <tr>
                                                        <td colspan="3" class="text-center text-white-50 py-3">Belum ada
                                                            data</td>
                                                    </tr>
                                                </c:if>
                                            </tbody>
