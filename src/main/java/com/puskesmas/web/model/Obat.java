package com.puskesmas.web.model;
...
public class Obat {
    ...
    public String getLokasiPenyimpanan() { return lokasiPenyimpanan; }
    public void setLokasiPenyimpanan(String lokasiPenyimpanan) { this.lokasiPenyimpanan = lokasiPenyimpanan; }
